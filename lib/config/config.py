...
__C.CT_MIN_MAX = [-1500, 5800]  # 此处必须给默认值
__C.XRAY1_MIN_MAX = [0., 255.0]
__C.XRAY2_MIN_MAX = [0., 255.0]
__C.CT_MEAN_STD = [0., 1.0]
__C.XRAY1_MEAN_STD = [0., 1.0]
__C.XRAY2_MEAN_STD = [0., 1.0]
__C.CT_MIN_MAX_LIMITATION = [-1500, 500]
...
__C.NETWORK.n_layers_D = 3 # 定义了discriminator里面的layer数目
...
__C.NETWORK.if_ema = False # 是否使用ema
__C.NETWORK.beta_ema = 0.9999 # ema的beta值
